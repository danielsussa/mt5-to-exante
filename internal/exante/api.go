...
func (h HTTPApi) PlaceOrderV3(req *OrderSentTypeV3) ([]OrderSentTypeV3Response, error) {
...
func (h HTTPApi) PlaceOrderV3Old(req *OrderSentTypeV3) ([]OrderSentTypeV3Response, error) {
	var k []OrderSentTypeV3Response
	err := h.postWithResponse(req, &k, requestData{
		action:   ordersAction,
		version:  APIv3,
		category: TRADEAPICategory,
	})
...
func (h HTTPApi) ReplaceOrderOld(orderID string, r ReplaceOrderPayload) error {
...
func (h HTTPApi) ReplaceOrder(orderID string, req ReplaceOrderPayload) (*ReplaceOrderResponse, error) {
